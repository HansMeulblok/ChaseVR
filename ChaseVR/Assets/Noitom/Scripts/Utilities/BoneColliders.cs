...
namespace Neuron
{
	public static class BoneColliders
	{
		...
		public static void AddSkeletonColliders( Transform root, string prefix, string prefab_path, string prefab_path2, int layer )
		{
			...
			//int bound_count = 
            NeuronHelper.Bind( root, dest_bones, prefix, false , NeuronBoneVersion.NotSet_AutoByName);
			...
			//bound_count = 
            NeuronHelper.Bind( src_object.transform, src_bones, "", false, NeuronBoneVersion.NotSet_AutoByName);
			//if( bound_count < (int)NeuronBones.NumOfBones )
			//{
